...
namespace CurlUnity
{
    ...
    public class CurlEasy : IDisposable
    {
        ...
        static readonly IntPtr cacertptr;
        ...
        static CurlEasy()
        {
            ...
            cacertptr = Marshal.AllocHGlobal(CACERT.Length);
        ...
        private void Prepare()
        {
            try
            {
                ...
                // Ca cert path
                {
                    CurlBlob blob = new CurlBlob
                    {
                        data = cacertptr,
                        len = (UIntPtr)CACERT.Length,
                        flags = 0,
                    };
                    SetOpt(CURLOPT.CAINFO_BLOB, blob);
                }
        ...
        static readonly byte[] CACERT = Encoding.UTF8.GetBytes(@"##
